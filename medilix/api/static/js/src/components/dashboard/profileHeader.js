            ...
            <div className="block">
                <div className="content bg-image" style={{backgroundImage: `url(${path + backgroundImageSrc})`}}>
                    <div className="push-15 clearfix">
                        ...
                        <h2 className="h4 text-black-op animated zoomIn">{data.specialization}</h2>
                        <Link to={`/app/doctors/${data.user_id}/timetable`}>
                            <button id="timetable-button" className="btn btn-rounded btn-success push-30-t push-10" type="button"><i className="si si-calendar"/> Timetable</button>
                        </Link>
                    </div>
                </div>
            </div>
